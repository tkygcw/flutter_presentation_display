...
class FlutterPresentationDisplayPlugin :
    FlutterPlugin,
    ActivityAware,
                ...
                try {
                    ...
                    if (display != null) {
                        val dataToMainCallback: (Any?) -> Unit = { argument ->
                            flutterBinding?.let {
                                MethodChannel(it.binaryMessenger, mainViewTypeId)
                                    .invokeMethod("transferDataToMain", argument)
                            }
                        }
                        ...
                        if (flutterEngine != null) {
                            ...
                            presentation = context?.let { ctx ->
                                PresentationDisplay(ctx, tag, display, dataToMainCallback)
                            }
                            presentation?.show()
                            result.success(true)
                        } else {
